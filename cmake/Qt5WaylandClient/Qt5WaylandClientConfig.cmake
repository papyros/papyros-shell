...
if(_realCurr STREQUAL _realOrig)
    ...
    get_filename_component(_qt5WaylandClient_install_prefix "/usr" ABSOLUTE)
endif()
unset(_realOrig)
unset(_realCurr)
...
if (NOT TARGET Qt5::WaylandClient)
    ...
    foreach(_module_dep ${_Qt5WaylandClient_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.5 ${_Qt5WaylandClient_FIND_VERSION_EXACT}
    ...
    _populate_WaylandClient_target_properties(RELEASE "libQt5WaylandClient.so.5.5" "" )
